...
void draw()
{
  ...
  if (keyPressed == true) {
    ...
    //left hand and body light red color
    fill(255, 0, 0);
    rect(+125, +207, 106, 47);
    rect(+167, +185, 44, 23);
    rect(+167, +254, 22, 23);
